...
The stat block is design doc §4.4, minus the parts later slices own: the energy
gauge and the ability are slice C, resummon pace is read by slice D. They are
declared here because the *type* carries them; nothing in slice A reads them.
